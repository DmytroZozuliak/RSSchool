...
// ibg();
console.log(`
На мой взляд все сделал.
1) Из анимаций:
- ripple effect при нажатии на кнопках главного меню и меню настроек
- при наведении на карточки категорий, всплывает выпадающее меню на переход к результатам раунда
- перелистование вопросов
- анимация кнопки настроек
- анимация исчезновений при переходе со "страницы" на "страницу"
- анимация выдвижения информации при клике на карточку на странице с результатами
- анимация появления картинок. заметно в блитце и в квизе про картины

2) при маленьком разрешении єкрана кнопку домой с игр и секций убираю, можно нажать на логотип, он вернет "домой"

3) Доп функционал:
+2 балла за разные модальные окна при прохождении уровня на 0 баллов, на 10 баллов или от 1 до 9
+10 баллов за мини игру, блитц, где игроку дается время 1 минута для угадывания правильного ответа. При правильном ответе к основному времени добавляется +5 сек, при неправильном -5 сек. Лучший результат записывается в локал сторейдж.

Ваша оценка - 232 баллов 
Отзыв по пунктам ТЗ:
Частично выполненные пункты:
1) 12 баллов дополнительными баллами оценивается очень высокое качество оформления приложения, продуманность отдельных деталей интерфейса, улучшающие внешний вид приложения и удобство пользования им, а также выполненный на высоком уровне и сложный в реализации свой собственный дополнительный функционал, существенно улучшающий качество и/или возможности приложения 
