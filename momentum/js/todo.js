...
export function todo() {
  ...
  const deleteAllBtn = document.querySelector('.popup-todo-footer button');
  let listArray;
  ...
  deleteAllBtn.onclick = () => {
    ...
    const pendingTasksNumb = document.querySelector('.pendingTasks');
    pendingTasksNumb.textContent = listArray.length; //passing the array length
  };
}
